...
Config.Languages = {
  ...
  ['br'] = {
        ...
        ['danceemotes'] = "🕺 Danças",
        ['propemotes'] = "📦 Objetos",
        ['favoriteemotes'] = "🌟 Favorito",
        ['favoriteinfo'] = "Selecione aqui um emote para definir como favorito.",
        ['rfavorite'] = "Redefinir favorito",
        ['prop2info'] = "❓ Emotes com objetos no fim da lista",
        ['set'] = "Definir (",
        ['setboundemote'] = ") como seu emote favorito?",
        ['newsetemote'] = "~w~ agora é o seu emote favorito. Pressione ~g~CapsLock~w~ para ativar.",
        ['cancelemote'] = "Cancelar emote",
        ['cancelemoteinfo'] = "~r~X~w~ Cancela o emote em atividade",
        ['walkingstyles'] = "Estilo de andar",
        ['resetdef'] = "Redefinir como padrão",
        ['normalreset'] = "Normal (Redefinir)",
        ['moods'] = "Humor",
        ['infoupdate'] = "Informação",
        ['infoupdateav'] = "Informação (Atualização disponível)",
        ['infoupdateavtext'] = "Uma atualização está disponível. Obtenha a nova versão em ~y~https://github.com/andristum/dpemotes~w~",
        ['suggestions'] = "Sugestões?",
        ['suggestionsinfo'] = "'dullpear_dev' no forum FiveM para enviar qualquer sugestão! ✉️",
        ['notvaliddance'] = "não é uma dança válida.",
        ['notvalidemote'] = "não é um emote válido.",
        ['nocancel'] = "Nenhum emote em atividade para cancelar.",
        ['maleonly'] = "Este emote é masculino, desculpe!",
        ['emotemenucmd'] = "Para abrir o menu de emotes use /emotemenu.",
        ['shareemotes'] = "👫 Interações",
        ['shareemotesinfo'] = "Convide alguém próximo para interagir",
        ['sharedanceemotes'] = "🕺 Danças interativas",
        ['notvalidsharedemote'] = "não é uma interação válida.",
        ['sentrequestto'] = "Convite enviado para ~y~",
        ['nobodyclose'] = "Ninguém ~r~perto~w~ o suficiente.",
        ['doyouwanna'] = "~y~Y~w~ para aceitar, ~r~L~w~ para recusar (~g~",
        ['refuseemote'] = "Interação recusada.",
        ['makenearby'] = "faz o jogador próximo interagir com",
        ['camera'] = "Pressione ~y~G~w~ para usar o flash da câmera.",
        ['makeitrain'] = "Pressione ~y~G~w~ jogar dinheiro.",
        ['pee'] = "Segure ~y~G~w~ para urinar.",
        ['spraychamp'] = "Segure ~y~G~w~ para espirrar champagne",
        ['bound'] = "Vinculado ",
        ['to'] = "a",
